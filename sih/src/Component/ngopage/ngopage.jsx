...
export default function NGOPage() {
  ...
  const fakeNGOs = [
    ...
    },
    {
      ...
      "description": "Dedicated to improving kidney health and transplant services.",
      "specialty": "Kidney",
      "email": "yajash40@gmail.com"
    },
    {
    ...
    },
    {
      ...
      "description": "Providing education and care for individuals with diabetes.",
      "specialty": "Diabetes",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "VisionForAll",
      "description": "Offering support and treatment for visually impaired individuals.",
      "specialty": "Ophthalmology",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Mental Wellness Trust",
      "description": "Promoting mental health awareness and providing counseling services.",
    ...
    },
    {
      ...
      "description": "Connecting blood donors with patients in need of transfusions.",
      "specialty": "Donation",
      "email": "yajash40@gmail.com"
    },
    {
    ...
    },
    {
      ...
      "description": "Providing healthcare support for individuals living with HIV.",
      "specialty": "HIV",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Epilepsy Empowerment",
      "description": "Helping patients with epilepsy manage their condition effectively.",
      "specialty": "Epilepsy",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Stroke Support Group",
      "description": "Assisting stroke survivors with recovery and rehabilitation.",
      "specialty": "Stroke",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Alzheimer’s Aid",
      "description": "Providing care and support for Alzheimer's patients and families.",
    ...
    },
    {
      ...
      "description": "Providing resources and support for Parkinson's disease patients.",
    ...
    },
    {
      ...
      "description": "Support for patients diagnosed with rare and uncommon diseases.",
      "specialty": "RareDiseases",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Endometriosis Awareness Network",
      "description": "Helping women cope with endometriosis through support and education.",
      "specialty": "Endometriosis",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Multiple Sclerosis Care",
      "description": "Providing resources and care for multiple sclerosis patients.",
      "specialty": "MS",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Cystic Fibrosis Support",
      "description": "Offering treatment and resources for cystic fibrosis patients.",
      "specialty": "CysticFibrosis",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Prostate Cancer Aid",
      "description": "Supporting prostate cancer patients with care and treatment.",
      "specialty": "ProstateCancer",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Asthma Action Network",
      "description": "Helping patients manage asthma symptoms with care and support.",
      "specialty": "Asthma",
      "email": "yajash40@gmail.com"
    },
    {
    ...
    },
    {
      ...
      "description": "Supporting patients dealing with lupus through care and resources.",
      "specialty": "Lupus",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "ALS Support Foundation",
      "description": "Providing care and support for ALS patients and their families.",
      "specialty": "ALS",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Dermatitis Care Initiative",
      "description": "Helping patients manage dermatitis through education and care.",
      "specialty": "Dermatitis",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Pancreatic Cancer Foundation",
      "description": "Dedicated to supporting pancreatic cancer patients with treatment.",
    ...
    },
    {
      ...
      "description": "Helping patients with anemia through education and resources.",
      "specialty": "Anemia",
      "email": "yajash40@gmail.com"
    },
    {
      "name": "Psoriasis Support Group",
      "description": "Providing care and resources for individuals with psoriasis.",
      "specialty": "Psoriasis",
      "email": "yajash40@gmail.com"
    },
    {
    ...
    },
    {
      ...
      "description": "Providing care for patients with Crohn’s disease and colitis.",
      "specialty": "Crohns",
      "email": "yajash40@gmail.com"
    }
  ]  
    ...
    function handleFormSubmit(event) {
      ...
      const filteredNGOs = fakeNGOs.filter((ngo)=>searchText.toLowerCase() === ngo.specialty.toLowerCase());
        ...
        <div className="bg-white p-4 rounded-lg shadow-green-500 shadow flex flex-col items-center justify-center mt-6">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center w-full">
              {ngos.length > 0 ? ngos.map((ngo, index) => {
                return (
                  <div
                    key={index}
